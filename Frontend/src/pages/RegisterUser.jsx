...
import userApi from '../api/userApi';  // Change the import to your user API
import './register.css';
...
const Register = () => {    
    ...
    const handleSubmit = async (e) => {
        ...
        const v4 = profileAvatar.length > 0; // Avatar check
        if (!v1 || !v2 || !v3 || !v4) {
        ...
        try {
            ...
            const response = await userApi.register(userData);  // Assume userApi has a register method
